...
public class LoginActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Site Spare Update - Login");
    ...
    public void login() {
        ...
        UserBDD login = new UserBDD(LoginActivity.this);
        login.open();
        if (login.getLogin(email,password).toString().equals("OK"))
        {onLoginSuccess();Toast.makeText(getApplicationContext(),
                login.getLogin(email,password).toString(),Toast.LENGTH_SHORT).show();} else{onLoginFailed();}
        login.close();
